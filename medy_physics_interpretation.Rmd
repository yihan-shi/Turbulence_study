---
title: "medy_physics_interpretation"
author: "Medy Mu"
date: "2022-11-02"
output: pdf_document
---
...
Generalized additive model (GAM) yields the lowest MSE and highest adjusted R^2, suggesting that it outperforms all other models fitted and thus has a high preditive power for raw moment 2. However, GAMs lacks interpretibility compared to simpler models, such as polynomial regression and least square regression. For statistical inference, therefore, polynomial models were chosen to 
